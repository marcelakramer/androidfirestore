...
@Composable
fun TelaCadastro(modifier: Modifier = Modifier, onSignupClick: () -> Unit, usuarioDAO: UsuarioDAO) {
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = modifier.fillMaxWidth()) {
        ...
        Spacer(modifier = Modifier.height(10.dp))
        OutlinedTextField(value = confirmacaoSenha, visualTransformation = PasswordVisualTransformation(),
            onValueChange = { confirmacaoSenha = it }, label = { Text(text = "Confirme a Senha") })
